  ...
  return (
    <div className="cp2-page-header">
      <div className="cp2-header-inner">
        ...
        <img src="/logo.svg" alt="Sunrack Logo" className="cp2-logo" />
      </div>
...
function PageFooter() {
  return (
    <div className="cp2-page-footer">
      <div className="cp2-footer-line" />
      <span className="cp2-footer-text">SUNRACK TECHNOLOGIES LLP, BOISAR, PALGHAR</span>
    </div>
  )
}
...
export default function CertificatePreview2({ data }) {
  ...
  return (
    <div className="cp2-viewer">

      {/* ══ PAGE 1 ══ */}
      <div className="cp2-page">
        <PageHeader />
        <div className="cp2-page-content">

          <div className="cp-title" style={{ marginBottom: 10 }}>WARRANTY CERTIFICATE</div>
      ...
      <div className="cp2-page">
        ...
        <div className="cp2-page-content">
          ...
          {/* Signature block */}
          <div className="cp-signature-block" style={{ margin: '16px 32px 0' }}>
